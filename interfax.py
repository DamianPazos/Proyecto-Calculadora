...
boton_cuatro = Button(root, text = '4', padx = 40, pady = 20, command = lambda:[click_boton_numero_display_uno(4), click_boton_numero_display_uno(4)]).grid(row = 4, column = 0, sticky = W+E)
...
boton_igual = Button(root, text = '=', padx = 40, pady = 20).grid(row = 6, column = 2, sticky = W+E)
boton_coma = Button(root, text = '.', padx = 40, pady = 20, command = lambda:click_boton_operacion('.')).grid(row = 6, column = 1, sticky = W+E)
...
display_total = Entry(root, textvariable = input_text_numero_display_dos).grid(row = 2, column = 1, columnspan = 3, sticky = W+E)
